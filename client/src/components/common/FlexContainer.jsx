...
const FlexContainer = () => {
  return (
    <div className="flex-container">
      ...
      <div className="date-cont"><h4 className="flex-container-text-style">Date</h4></div>
      ...
      <div className="quantity-cont"><h4 className="flex-container-text-style">Quantity</h4></div>
    </div>
  );
}
